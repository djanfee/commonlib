...
func GetCurrencyCodeFromCtx(ctx context.Context) string {
	return cast.ToString(ctx.Value(CtxCurrency))
}

// GetMerchantIDFromCtx 从上下文中获取商户id
func GetMerchantIDFromCtx(ctx context.Context) string {
	return cast.ToString(ctx.Value(CtxMerchantID))
}
